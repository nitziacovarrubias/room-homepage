...
export default function Main() {
  const pClass = 'text-[var(--grey-500)] mb-6 xl:text-[1.125rem] xl:mb-8';
  
  return (
    <main className='md:flex'>
      <Slider images={IMAGES}/>
      <Section className="py-16 px-8 flex-col xl:px-14">
        <h1 className='font-bold text-4xl mb-4 xl:text-5xl xl:mb-6 xl:mt-6'>Discover innovative ways to decorate</h1>
